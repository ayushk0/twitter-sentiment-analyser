...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://github.com/ayushk0',
...
st.sidebar.title("Made by students of BPIT: ")
st.sidebar.text('Aryan Adarsh - 21120803120')
st.sidebar.text('Ayush Kumar - 20320803120')
st.sidebar.text('Rahul Kumar - 20620803120')  
